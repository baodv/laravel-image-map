        ...
        d = {
            ...
            renderSVG: function(b) {
                ...
                f.css("width", "100%"), a(".image-mapper-shape", f).remove(), a.each(c[b].area, function(g, h) {
                    ...
                    "poly" == h.shape ? (i || (i = a(document.createElementNS("http://www.w3.org/2000/svg", "polygon"))), 
                        i.attr("points", j.join(","))) : "circle" == h.shape ? j.length >= 4 && (i || (i = a(document.createElementNS("http://www.w3.org/2000/svg", "circle"))), i.attr("cx", j[0]).attr("cy", j[1]), i.attr("r", Math.sqrt(Math.pow(j[2] - j[0], 2) + Math.pow(j[3] - j[1], 2)))) : j.length >= 4 && (i || (i = a(document.createElementNS("http://www.w3.org/2000/svg", "rect"))), i.attr("x", Math.min(j[0], j[2])).attr("y", Math.min(j[1], j[3])), 
            ...
            asHTML: function(b) {
                ...
                a.each(c[b].area, function(d, e) {
                    ...
                    $('form').append('<input type="hidden" name="area[]" value="'+f+'"/>')
                    var i = a("<area />");
